...
<div style={{ backgroundColor:"#0A0519",  marginTop:"-290px" ,padding:"4px",  minWidth:"300px" , borderRadius:"15px" ,  border:"1px solid #26F8FF", width:"25%"  }}  >
       ...
       <Box  style={{ marginTop:"-7px",  width:"100%",paddingBottom:"20px" }} >
          {connectors.map((connector) => (
              <> 
             
              {/*  style={{display:"flex", width:"90%",  margin:"12px", padding:"5px", borderRadius:"15px"}} */}
              <Box   className="click"  key={connector.id}  onClick={() => connection(connector)}>
