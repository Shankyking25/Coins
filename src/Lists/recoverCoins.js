    ...
    return (
        <>
                    ...
                    {/*   display="flex" justifyContent="space-between" alignItems="center"        */}
                          ...
                          <Grid   item xs={12} xl={9}    md={9}    style={{ backgroundColor:"black" ,border:"2px solid black"}}>
                            <Box  style={{display:"flex"}}    p={1} mt={1}  >
                                <Box  pl={6}  textAlign="center" width={"100%"} style={{display:"flex"}}   > 
                                  <Box>
                                    ...
                                    <h5  style={{marginBottom:"0px", fontSize:"20px", color:"black", marginTop:"0px",color:"white"}}  >InfinityVoid</h5>
                                    </Box>
                                  </Box> 
...
{/*
                      <input  className='indata'    onKeyUp={()=> mult(this.value)}
          placeholder="0.00" style={{marginTop:"5px",border: "none",  color: "#95B9C7", outline: "none", background: "transparent", width: "84px", fontSize: "38px" }} />
                              */}      
                                      ...
                                      <Grid    item   xs={12} textAlign="center"md={5.5}   xl={8}  >
                                       </Grid>  

                                      
                                        <Grid container item  md={6.5}   xs={12} xl={4} justifyContent="center"  textAlign="center" >     
                                    ...
                                    <Box pl={1}  pt={0.5}  style={{ backgroundColor:"#3090C7", height:"45%", width:"48px" ,   borderRadius:"8px 0 0 8px"}}>
                                        <input className='indata' placeholder="40000.00"  style={{ color:"#95B9C7",outline:"none",border:"none", background:"transparent", width:"48px" ,fontSize:"17px" }}   />
                                         </Box>
                                    </Grid>
  ...
  alignItems="center"   style={{paddingTop:"50px", paddingBottom:"50px", paddingRight:"10px"  }}   >
                                  ...
                                  <ArrowCircleRightIcon  onClick={calculateTotal}  style={{fontSize: "50px", color:"white" }} sx={{ cursor: "pointer" }} />
            ...
            onChange = {(e) => setText(e.target.value)} 
                    ...
                    */}
                        ...
                        <Grid container xs={12} >
                              <Grid container xl={4.3}   item xs={12}  md={6.7}      spacing={0}
                                  // alignItems="center"
                                justifyContent="center" >
                                    
                         
                                    <Grid item  ml={-3}  pr={0.5} pt={0.8} >
                                    ...
                                    <Box  pl={1}  pt={0.5}  style={{ backgroundColor:"#3090C7", height:"45%", borderRadius:"8px 0 0 8px"}}>
                                        <input className='indata' readOnly  placeholder="0.000025"  style={{ color:"#95B9C7",outline:"none",border:"none", background:"transparent", width:"52px" ,fontSize:"17px" }} />
                                         </Box>
                                    </Grid>
