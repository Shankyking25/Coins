  ...
  const [text, setText] = useState({ result });
    ...
    return (
       ...
       <Box mt={1}  p={1}  style={{display:"flex",  }} >
        ...
        <Box    style={{ width:"30%" , marginTop:"-2px" }}  >           
          ...
          <Grid  item    xl={12} xs={12} lg={12} mx="auto"  mt={3}  mb={10}  >
            ...
            <Box mb={10} style={{ backgroundColor: "#157DEC", borderRadius: "18px ",  width: "100%", height: "100%",  boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)" }}>            
                            ...
                            <Grid   container spacing={3} xs={12} lg={12} mx="auto" mt={7}      >
                              ...
                              <Grid container xs={12} md={5}   >
                                ...
                                <Grid container item  md={12} >
                                     ...
                                     <Grid    mt={1.5}    item   xs={12} lg={5} xl={5.5} md={4} >
                                      </Grid>  

                                      <Grid mt={1.5}     container item xs={12} lg={7}  xl={6.5} md={8} alignItems="center"  justifyContent="center"   >     
                      ...
                      {/*
                      <select   onChange={handleOptionSelect} style={{ width: "50%", height: "40px", fontSize: "30px", border: "none", color: "white", outline: "none", background: "transparent", }}   >
       
                        <option  className='smBox' value="option1" style={{ width:"30%",  fontSize: "30px",color:"black"  }}>MATIC</option>
                        <option value="option2"   style={{width:"30%",fontSize:"40px", color:"black"}}>WETH</option>
        ...
        <InputLabel   id="demo-simple-select-label" style={{color:"white", outline: "none", fontSize:"26px"}}   >MATIC</InputLabel>
                        <Select
      ...
      //    labelId="demo-simple-select-label"
       //   id="demo-simple-select"
        ...
        >
          ...
          <MenuItem value={20}>MATIC</MenuItem>
        </Select>
      </FormControl>
                        */}
